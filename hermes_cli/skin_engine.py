...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    ...
    "toutfaire": {
        "name": "toutfaire",
        "description": "Toutfaire personal agent - teal and amber",
        "colors": {
            "banner_border": "#14B8A6",
            "banner_title": "#F59E0B",
            ...
            "session_label": "#2DD4BF",
            "session_border": "#0F766E",
        },
        "spinner": {
            "thinking_verbs": [
                "cherche", "analyse", "organise", "prepare", "verifie",
            ],
        },
        "branding": {
            "agent_name": "Toutfaire",
            "welcome": "Bienvenue dans Toutfaire. Que voulez-vous accomplir ?",
            "goodbye": "A bientot !",
            "response_label": " Toutfaire ",
            "prompt_symbol": ">",
            "help_header": "Toutfaire - Commandes disponibles",
        },
        "tool_prefix": "|",
    },
    "ares": {
